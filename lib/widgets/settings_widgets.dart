        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.tune_rounded, color: c.ink2),
            ...
            SettingsRow(
              ...
              child: Switch(
                ...
                onChanged: (value) => onPrefs(prefs.copyWith(infoStrip: value)),
              ),
            ),
            SettingsRow(
              c: c,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  '这些选项只影响本机显示和互动偏好。Token、后端、权限与通知已移到系统设置。',
                  style: serif(
                    c,
                    13,
                    color: c.ink2,
...
class SystemSettingsSheet extends StatelessWidget {
  const SystemSettingsSheet({
    super.key,
    required this.c,
